...
def backtest_v42(params, inst_map, start='2026-01-01', end='2026-03-31'):
    all_trades = []
    for code in STOCKS:
        try:
...
print('='*70)
print(' 市值前100大個股 - v4.2.0 Q1 2026 回測')
print('='*70)
...
print('\n[ 回測中... ]')
trades = backtest_v42(params, inst_map)
...
if result:
    ...
    print('  ATR 過低: %d 次' % result['fail']['low_atr'])
    print('  Bias 過大: %d 次' % result['fail']['high_bias'])
else:
    print(' 無交易資料')
print('='*70)