...
def load_inst_data():
    """Load all institutional data into memory"""
    inst_map = {}
        ...
        try:
            ...
            for i in range(25, len(cl)):
                ...
                if use_inst and code in inst_map:
                    ...
                    # Strict: require both foreign and trust buying
                    if inst_days == 4:
                        inst_sc = 40 if f_days >= 2 and t_days >= 2 else 15
                    else:
                ...
                all_trades.append({'ret': ret, 'rsi': rs, 'vr': vr, 'code': code, 'sc': sc})
...
# Test configurations
configs = [
    ('No Inst, RSI<65', {'max_rsi': 65, 'min_atr': 30, 'min_score': 72}, False, 3),
    ('Inst 3days, RSI<65', {'max_rsi': 65, 'min_atr': 30, 'min_score': 72}, True, 3),
    ('Inst 4days, RSI<65', {'max_rsi': 65, 'min_atr': 30, 'min_score': 72}, True, 4),
    ('Inst 3days, RSI<62', {'max_rsi': 62, 'min_atr': 30, 'min_score': 72}, True, 3),
    ('Inst 3days, Score>=78', {'max_rsi': 65, 'min_atr': 30, 'min_score': 78}, True, 3),
    ('Inst 3days, ATR>=40', {'max_rsi': 65, 'min_atr': 40, 'min_score': 72}, True, 3),
]
...
print()
print('='*70)
print(' BEST: %s, WR=%.1f%%' % (best['name'], best['wr']))
print('='*70)
