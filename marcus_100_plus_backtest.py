# -*- coding: utf-8 -*-
"""
Marcus - Top100+ 擴充回測系統 v2
目標: 擴充到 100 檔以上，修復下市股
"""
import sys
...
TIER3 = [s for s in TIER3_BLUE if s not in BLACKLIST][:40]
