...
US_CATS = {
    ...
    # === S&P 500 GICS Sectors (fetched from Wikipedia, 2026-05-05) ===
    ...
    "CS - Communication Services": ["CHTR","CMCSA","DIS","EA","FOX","FOXA","GOOG","GOOGL","LYV","META","NFLX","NWS","NWSA","OMC","SATS","T","TKO","TMUS","TTD","TTWO","VZ","WBD"],
